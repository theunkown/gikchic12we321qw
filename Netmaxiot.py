...
version_cmd = [8]
# No data is available from the Netmaxiot
...
# Write I2C block to the Netmaxiot
...
# Read I2C block from the Netmaxiot
...
# Doesn't look to be implemented on the Netmaxiot
def rtc_getTime():
